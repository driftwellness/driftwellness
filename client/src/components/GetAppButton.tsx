  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 right-4 z-40 flex items-center gap-2 px-3 py-2 bg-burgundy text-white rounded-full shadow-lg hover:shadow-xl hover:scale-105 transition-all text-sm font-semibold"
      >
