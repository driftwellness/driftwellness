...
export default function GetAppBadge() {
  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 right-4 z-50 flex items-center gap-1.5 px-3 py-1.5 bg-burgundy text-white rounded-full shadow-lg hover:shadow-xl hover:scale-110 transition-all text-xs font-bold border-2 border-gold"
      >
